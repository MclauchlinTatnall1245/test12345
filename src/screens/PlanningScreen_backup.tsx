...
export default function PlanningScreen() {
  ...
  const handleEditGoal = (updatedGoal: Goal) => {
    ...
    DataService.updateGoal(planningDate, updatedGoal.id, updatedGoal);
  };
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        {showDebug && (
          <Card style={styles.debugCard}>
            ...
            <Text style={styles.debugText}>Planning datum: {planningDate}</Text>
            <Text style={styles.debugText}>Debug functionaliteit komt later</Text>
          </Card>
        )}
        ...
        {showTimeline && goals.length > 0 && (
          <Card style={styles.timelineCard}>
            ...
            <Timeline 
              ...
              onToggleGoal={() => {}} // Planning screen doesn't toggle completion
              onMissGoal={() => {}} // Planning screen doesn't mark as missed
        ...
        {/* Edit Goal Form - inline editing */}
        {editingGoalId && goals.find(g => g.id === editingGoalId) && (
          <EditGoalForm
